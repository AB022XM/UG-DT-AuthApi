...
To build the final jar and optimize the UGDTAuthApi application for production, run:
...
Then navigate to [http://localhost:9040](http://localhost:9040) in your browser.
